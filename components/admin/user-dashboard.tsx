    ...
    const fetchHoldayData = async () => {
        ...
        try {
            if (data && data.token) {
                ...
                const response = await axios.post(`${publicRuntimeConfig.API_URL}dashboard`, JSON.stringify({ "type": "HOLIDAY_LIST", date: new Date() }), config);
                        ...
                        <Grid item xs={12} md={12}>
                            ...
                            <TableContainer component={Paper}>
                                <Table sx={{ minWidth: 800 }} aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {taskList.length > 0 && Array.isArray(taskList) && taskList.map((row, index) => (
                        ...
                        <Grid item xs={4} md={4}>
                            ...
                            <TableContainer component={Paper}>
                                <Table aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {holdayList.length > 0 && Array.isArray(holdayList) && holdayList.map((row, index) => (
                                            <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                        ...
                        <Grid item xs={4} md={4}>
                            ...
                            <TableContainer component={Paper}>
                                <Table aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {userReport.length > 0 && Array.isArray(userReport) && userReport.map((row, index) => (
                                            <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                        ...
                        <Grid item xs={4} md={4}>
                            ...
                            <TableContainer component={Paper}>
                                <Table aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {leaveList.length > 0 && Array.isArray(leaveList) && leaveList.map((row, index) => (
                                            <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
...

                                        {
                                            ...
                                            <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                <TableCell component="th" scope="row" colSpan={3}>
                                                    <Typography align='center'>{'No Leave List'}</Typography>
                                                </TableCell>
                                            </TableRow>
                                        }
                                    </TableBody>
                        ...
                        <Grid item xs={12} md={12}>
                            ...
                            <TableContainer component={Paper}>
                                <Table sx={{ minWidth: 800 }} aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {voucherList.length > 0 && Array.isArray(voucherList) && voucherList.map((row, index) => (
                                            <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
...

                                        {
                                            ...
                                            <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                <TableCell component="th" scope="row" colSpan={4}>
                                                    <Typography align='center'>{'No Voucher List'}</Typography>
                                                </TableCell>
                                            </TableRow>
                                        }
